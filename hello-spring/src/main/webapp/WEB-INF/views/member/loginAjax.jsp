...
$(() => {
	...
	.modal()
	.on('hide.bs.modal', e => {
		//hide.bs.modal : modal이 비활성화될 때 발생하는 이벤트(부트스트랩에서 제공하는 이벤트)
...
this.loginUser() {
	...
	jQuery.ajax({
		//컨트롤러 연결을 위한 코드를 완성한다.
		url : "${pageContext.request.contextPath}/member/testLogin.do",
		type : "GET"
		data : {
			name : userid,
			password : password
			...
			<div class="modal-content">
				...
				<!-- https://getbootstrap.com/docs/4.1/components/forms/#overview -->
					<div class="modal-body">
						<input type="text" class="form-control" name="userIdEdit"
