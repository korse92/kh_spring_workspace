...
public class MemberController {
	...
	public void memberDetail(
			Authentication authentication, @AuthenticationPrincipal Member member, Model model,
...
//		Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
		...
		log.debug("authorities.contains(\"ROLE_ADMIN\") = {}", authorities.contains(new SimpleGrantedAuthority("ROLE_ADMIN")));//권한 체크(equals, hashCode 오버라이딩되서 가능)		
		log.debug("requestWrapper.isUserInRole(\"ADMIN\") = {}", requestWrapper.isUserInRole("ADMIN"));
